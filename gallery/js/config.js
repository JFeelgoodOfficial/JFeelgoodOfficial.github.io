...
export const C = {
  ...
  // visitor stands inside the reach of five rows, but the falloff window has
  // closed so far by the third that even the low tier's four slots carry over
  // 95% of the light in the room, and what they drop cannot be seen going.
